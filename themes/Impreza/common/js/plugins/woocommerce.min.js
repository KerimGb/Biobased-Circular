!(function($,_undefined){const $ush=window.$ush||{};function WooCommerce(){const self=this;self.$cart=$('.w-cart');self.$notice=$('.w-wc-notices.woocommerce-notices-wrapper:first',$us.$canvas)
