...
! function( $, undefined ) {
	...
	function USHeader( settings ) {
		...
		// Events
		$us.$window
			.on( 'scroll.noPreventDefault', $ush.debounce( self._events.scroll.bind( self ), 1 ) )
		...
		_events: {
			...
			showBtn: function( e ) {
				...
				$us.$body
					...
					.on( ( $.isMobile ? 'touchstart.noPreventDefault' : 'click' ), self._events.hideMobileVerticalHeader.bind( self ) );
			},
